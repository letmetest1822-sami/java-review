...
public class BigDecimalPractice {
    ...
    System.out.println("BigDecimal : " + c1);
        ...
        System.out.println("BigDecimal.valueOf(3.5) + BigDecimal.valueOf(4) = " + sumResult);
